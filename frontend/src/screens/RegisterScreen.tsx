    ...
    <div style={{
      ...
      <div className="glass animate-slide-up" style={{ 
        ...
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          <h1 className="glow-text" style={{ fontSize: '2.5rem', marginBottom: '10px' }}>Create Account</h1>
          <p style={{ color: 'var(--text-secondary)' }}>Become a member of our exclusive circle.</p>
        </div>
        ...
        <form onSubmit={submitHandler} style={{ display: 'flex', flexDirection: 'column', gap: '25px' }}>
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              />
              <User size={18} style={{ position: 'absolute', left: '15px', top: '50%', transform: 'translateY(-50%)', color: 'var(--accent-gold)' }} />
            </div>
          </div>
          ...
          <p style={{ textAlign: 'center', marginTop: '10px', color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
            Already have an account? <Link to="/login" style={{ color: 'var(--accent-gold)', textDecoration: 'none', fontWeight: 600, display: 'inline-flex', alignItems: 'center', gap: '5px' }}>Sign In <ArrowRight size={14}/></Link>
          </p>
        </form>
      </div>
    </div>
