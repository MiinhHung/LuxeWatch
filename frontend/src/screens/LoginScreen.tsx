...
const LoginScreen = () => {
  ...
  return (
    <div className="container animate-slide-up" style={{ marginTop: '120px', maxWidth: '500px' }}>
      <h1 className="glow-text" style={{ fontSize: '3rem', marginBottom: '40px', textAlign: 'center' }}>Sign In</h1>
      ...
      <form className="glass" onSubmit={submitHandler} style={{ padding: '40px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <p style={{ textAlign: 'center', marginTop: '20px', color: 'var(--text-secondary)' }}>
          New customer? <Link to="/register" style={{ color: 'var(--accent-gold)' }}>Register here</Link>
        </p>
      </form>
    </div>
  );
